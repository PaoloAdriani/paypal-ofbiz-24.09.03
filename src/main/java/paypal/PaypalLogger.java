...
public class PaypalLogger {
    ...
    public static final String module = PaypalLogger.class.getName();

    private final static String PAYPAL_COOMPONENT = "paypal";
    private final static String LOGDIR = "LOG";
    private final static String LOG_FILE_PREFIX = "PAYP_";
    ...
    public PaypalLogger(String tenantId) {
        ...
        try {
            componentPath = ComponentConfig.getRootLocation(PAYPAL_COOMPONENT);
        ...
        /* if the tenant log directory exists, then create a log file for now date
           ...
           The file name is MSP_YYYYMMDD.log
        */
    ...
    /** Method that build a file name for the log file.
     * The file name has this form:
     * MSP_YYYYMMDD.log
